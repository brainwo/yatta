...
/// The search bar used for this intent must serve the main functionality of the screen.
/// If there are multiple search bar present in one screen, this should be only used on the search bar
/// that is more important and relevant to the context.
///
